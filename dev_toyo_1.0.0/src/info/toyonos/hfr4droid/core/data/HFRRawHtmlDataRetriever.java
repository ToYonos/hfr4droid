...
/**
 * <p>Version initiale du <code>HFRDataRetriever</code> qui parse les pages HTML du forum via des Regexps</p>
 * 
 * @author ToYonos
 * @see info.toyonos.core.data.HFRDataRetriever
 *
 */
public class HFRRawHtmlDataRetriever extends HFRDataRetriever
{
	...
	private String hashCheck = null;

	public HFRRawHtmlDataRetriever(Context context)
	{
		super(context);
	}
	
	public HFRRawHtmlDataRetriever(Context context, boolean clearCache)
	{
		super(context, clearCache);
	}

	public HFRRawHtmlDataRetriever(Context context, HFRAuthentication auth, boolean clearCache)
	{
